...
/**
 * Ruínas 29x35 (assets Pixel Art Top Down - Basic, by Cainos).
 * O visual é a própria cena do pack ("Scene Overview") renderizada como
 * imagem de chão; esta grade define somente colisão: `#` sólido, `.` livre.
 */
const RUINS_ROWS = [
  '#############################',
  '#############################',
...
export const SCENARIOS: Record<ScenarioId, ScenarioDef> = {
  ...
  ruins: {
    ...
    defaultTile: TileType.Floor,
    // Praça central de pedra, ao norte do baú.
    spawnTiles: [
      [11, 18], [12, 18], [13, 18], [14, 18], [11, 19], [12, 19], [13, 19], [14, 19],
    ],
  },
};
